export function setTGThemeColor(){
    if('Telegram' in window){
        if(Telegram.WebApp.themeParams.bg_color) document.documentElement.style.setProperty("--bg-secondery", Telegram.WebApp.themeParams.bg_color);
        if(Telegram.WebApp.themeParams.secondary_bg_color) document.documentElement.style.setProperty("--bg-main", Telegram.WebApp.themeParams.secondary_bg_color);
        ...
        if(Telegram.WebApp.themeParams.section_separator_color) document.documentElement.style.setProperty("--border-color", Telegram.WebApp.themeParams.section_separator_color);
